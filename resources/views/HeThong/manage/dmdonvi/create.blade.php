...
@stop
@section('content')
<form method="POST" action="{{'/dmdonvi/store'}}" accept-charset="UTF-8"  class="horizontal-form" id="update_dmdonvi" enctype="multipart/form-data">
    @csrf
    <div class="card card-custom wave wave-animate-slow wave-primary" style="min-height: 600px">
        ...
        <div class="card-footer">
            <div class="row text-center">
                <div class="col-lg-12">
                    <a href="{{$furl.'danh_sach_don_vi/'.$model_diaban->id}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
