...
<head>
    ...
    <link rel="shortcut icon" href="{{ url('assets/media/logos/Icon_Life.jpg') }}" />
</head>
...
<body id="kt_body" style="background-image: url({{ url('assets/media/bg/bg-10.jpg') }})"
    ...
    <div class="page-loader page-loader-logo">
        <img alt="Logo" class="max-h-75px" src="{{ url('assets/media/logos/Icon_Life.jpg') }}" />
    ...
    <div id="kt_header_mobile" class="header-mobile">
        <!--begin::Logo-->
        <a href="index.html">
            <img alt="Logo" src="{{ url('assets/media/logos/Icon_Life.jpg') }}" class="logo-default max-h-30px" />
        </a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="topbar-item">
                                    <div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto"
                                        ...
                                        <span
                                            class="text-white font-weight-bolder font-size-base d-none d-md-inline mr-4">Sean</span>
