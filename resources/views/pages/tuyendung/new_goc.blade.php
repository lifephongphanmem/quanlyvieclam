                        ...
                        <div class="col-sm-6   ">
                            <table class="table table-bordered ">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Ngoại ngữ 1 <input type="text" size=10 name="ngoaingu1[]" value=""> Chứng
                                        ...
                                        <br>
                                        Ngoại ngữ 2 <input type="text" size=10 value=" " name="ngoaingu2[]"> Chứng
                            ...
                            <table class="table table-bordered ">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="checkbox" class="phucloi" value="Đóng BHXH, BHYT, BHTN"> Đóng BHXH,
                                        BHYT, BHTN
                                        <input type="checkbox" class="phucloi" value="Đóng BHNT"> Đóng BHNT
                                        <input type="checkbox" class="phucloi" value="Trợ cấp thôi việc"> Trợ cấp thôi
                                        việc
                                        ...
                                        <input type="checkbox" class="phucloi" value="Lối đi người khuyết tật"> Lối đi
                                        người khuyết tật
                                        <input type="checkbox" class="phucloi" value="Cơ hội thăng tiến"> Cơ hội thăng
                                        tiến
                                        <br>
                                        <input type="checkbox" id="checkphucloikhac"> Khác <input type="text"
                                            id="phucloikhac" value="" size=30>
