...
<div class="row ">	
	<div class="col-sm-7 col-sm-offset-1">
		...
		<select class="input-sm form-control w-sm inline v-middle" name="time_filter" onchange="this.form.submit()">
          <option value="1" <?php if($time_filter==1){echo "selected";}?>>Kì hiện tại</option>
          <option value="2"<?php if($time_filter==2){echo "selected";}?>>Kỳ trước</option>
          <option value="3"<?php if($time_filter==3){echo "selected";}?>>Năm hiện tại</option>
