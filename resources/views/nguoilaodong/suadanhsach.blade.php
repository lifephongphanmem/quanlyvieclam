...
<form action="{{'/nguoilaodong/CapNhatDanhSach/'.$model->id}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="card-footer">
        <div class="row text-center">
            <div class="col-lg-12">
                <a href="{{url('/cungld/danh_sach/don_vi/tonghop?math='.$model->math)}}" class="btn btn-danger mr-5"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
