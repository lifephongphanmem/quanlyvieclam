                        ...
                        <tbody>
                            @foreach ($model as $key => $th)
                                <tr class="text-center">
                                    ...
                                    <td class="{{ $th->thoigiangui == null ? 'text-danger' : '' }}">
                                        {{ $th->thoigiangui == null ? 'Chưa gửi' : \Carbon\Carbon::parse($th->thoigiangui)->format('d/m/Y') }}
                                    </td>
                                    <td>
                                        @if ($th->thoigiangui == null)
                                        <button title="Sửa thông tin"
                                            onclick="edit(this,'{{ '/thongbao_khac/update/' . $th->id }}')"
                                            class="btn btn-sm btn-clean btn-icon" data-target="#modify-modal-edit" data-toggle="modal">
                                            <i class="icon-lg la flaticon-edit-1 text-primary"></i>
                                        </button>
                                        <button title="Xóa thông tin" type="button"
                                            onclick="cfDel('{{ '/thongbao_khac/delete/' . $th->id }}')"
