...
@stop
@section('content')
<form method="POST" action="{{'/cungld/thongbao/store'}}" accept-charset="UTF-8"  class="horizontal-form" id="them_thongbao" enctype="multipart/form-data">
    @csrf
        ...
        <div class="card-body">
            <div class="form-group">
                <div class="col-lg-6">
                    ...
                    <input class="form-control" required="" autofocus="" name="tieude" type="text">
                </div>
            </div>
            <div class="form-group ">
                <div class="col-lg-12">
