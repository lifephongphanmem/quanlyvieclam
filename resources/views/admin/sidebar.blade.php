...
@section('sidebar')
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li class="sub-menu">
                    <a class=" {{ Request::is('dmhc*') ? 'active' : '' }} {{ request()->is('ptype*') ? 'active' : '' }} {{ request()->is('param*') ? 'active' : '' }} {{ Request::is('user*') ? 'active' : '' }}" href="#">
                        <i class="fa fa-cogs"></i>
                        <span><h4>HỆ THỐNG</h4></span>
                    </a>
                <ul>
				<li class="sub-menu">
				...
				<li class="sub-menu">
                   <a href="{{URL::to('ptype-ba')}}" class="{{ request()->is('param*') ? 'active' : '' }}{{ request()->is('ptype*') ? 'active' : '' }}"> <i class="fa fa-users"></i> Tham số</a>
				...
				<li  class="sub-menu">
                    <a href="#" class="{{ Request::is('admessages*') ? 'active' : '' }} {{ Request::is('tuyendung*') ? 'active' : '' }}{{ Request::is('employer*') ? 'active' : '' }}{{ Request::is('doanhnghiep*') ? 'active' : '' }} {{ Request::is('report*') ? 'active' : '' }}">
                        <i class="fa fa-dashboard"></i>
                        <span><h4>DOANH NGHIỆP</h4></span>
                    </a>
                <ul>
                <li class="sub">
                    <a href="{{URL::to('doanhnghiep-ba')}}" class="{{ Request::is('doanhnghiep*') ? 'active' : '' }} ">
                ...
                <li class="sub">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('hogiadinh')}}">Tìm kiếm</a></li>
						<li><a href="{{URL::to('add-hogiadinh')}}">Tạo mới</a></li>                     					                               					                       
                    </ul>
                </li>
				<li class="sub">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="#">Tìm kiếm thành viên </a></li>
				...
				<li class="sub-menu" style="display:none;">
                    <a class="" href="#">
                        ...
                        <span><h4>QUẢN LÝ CÔNG VIỆC</h4></span>
                    </a>
                </li>
				<li class="sub-menu" style="display:none;">
                    <a class="" href="#">
                        <i class="fa fa-tasks"></i>
                        <span><h4>SÀN GIAO DỊCH</h4></span>
                    </a>
					<ul>
                <li class="sub">
                    <a href="javascript:;">
