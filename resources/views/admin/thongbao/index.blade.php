...
@section('content')
            ...
            <div class="card card-custom">
                <div class="card-header card-header-tabs-line">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ 'thong_bao/them_moi' }}" class="btn btn-xs btn-icon btn-success mr-2"
                        ...
                        <table class="table table-striped b-t b-light table-hover">
                            ...
                            <tbody>
                                ...
                                <tr >
                                    ...
                                    <td>
                                        @if ($item->trangthai == 'cg')
                                            <a href="{{ '/thong_bao/chinh_sua?matb=' . $item->matb }}" title="Sửa"
    ...
    <div id="chuyen-modal" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        <form id="frm_chuyen" method="post" accept-charset="UTF-8" action="{{ 'thong_bao/chuyen' }}">
            @csrf
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" onclick="submitchuyen()" data-dismiss="modal" class="btn btn-primary">Đồng
                            ý gửi</button>
                    </div>
                </div>
            </div>
