...
@section('content')
    ...
    <!-- modal gửi thông báo -->
    <form method="POST" action="{{'/TimKiem/LaoDongNuocNgoai/InKetQua'}}" accept-charset="UTF-8" id="frm_modify_send" target="_blank">
        @csrf
                ...
                <div class="modal-content">
                    <div class="modal-header modal-header-primary">
                        ...
                        <button type="button" data-dismiss="modal" aria-hidden="true" class="close">×</button>
                            ...
                            <input type="hidden" name="nation" value="{{$inputs['nation']}}">
